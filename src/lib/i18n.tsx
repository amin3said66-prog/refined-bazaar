...
export const t: Dict = {
  ...
  "projects.search": {
    en: "Search by name, client or technology…",
    ar: "ابحث بالاسم أو العميل أو التقنية…",
  },
  "projects.sortBy": { en: "Sort by", ar: "ترتيب حسب" },
  "projects.view": { en: "View", ar: "العرض" },
  "projects.reset": { en: "Reset", ar: "إعادة تعيين" },
  "projects.empty": {
    en: "No projects match these filters yet.",
    ar: "لا توجد مشاريع مطابقة لهذه الفلاتر.",
  },
  "projects.related": { en: "Related projects", ar: "مشاريع ذات صلة" },
